...
import sys
from Detection.ScaledYOLOv4.models.common import *
from Detection.ScaledYOLOv4.models.experimental import MixConv2d, CrossConv, C3
from Detection.ScaledYOLOv4.utils.general import check_anchor_order, make_divisible, check_file
from Detection.ScaledYOLOv4.utils.torch_utils import (
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    anchorlens, nc, gd, gw = d['anchors'], d['nc'], d['depth_multiple'], d['width_multiple']
    na = ((anchors[0]) // 2) if isinstance(anchors, list) else anchors  # number of anchors
